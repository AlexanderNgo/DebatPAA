...
public class SolutionPotentielle {
	...
	**/
	public void add(String arg){
		if (arguments.contains(arg)) {
			System.out.println("L'argument "+arg+" est dï¿½ja dans E");
		}else {
			arguments.add(arg);
		}
	}
	...
	*	@param String arg
	*	@return NONE
	*	Description : Enlï¿½ve un argument de la solution potentielle E
	**/
	...
	*	@return boolean
	*	Description : Mï¿½thode placï¿½ dans la mï¿½thode principale de verif, qui va tester si l'ensemble E se contredit ou pas.
	**/
